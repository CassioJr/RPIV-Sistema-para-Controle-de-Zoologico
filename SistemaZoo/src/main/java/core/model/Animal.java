...
public class Animal {
	...
	private int numeroAbrigo;
	private String datatransfenciaInstituicao;
	private String medidaQuantidade_Alimento;
	private float tamanhoAbrigo;
	private float quantidadeDiaria_Alimento;
