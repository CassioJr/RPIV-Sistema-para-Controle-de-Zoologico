  ...
  //Método para impedir que letras sejam escritas nos campos n�mericos
	...
	public void pegarInformacoes() {
		Animal a = new Animal(nomeAnimal.getText(), nomeAlimentoAnimal.getText(), situacaoAnimal.getText(),
				...
				Integer.parseInt(numeroAbrigoAnimal.getText()), dataTransferencia(),
				medidaAlimentoAnimal.getText(), Float.parseFloat(tamanhoAnimal.getText()),
				Float.parseFloat(quantidadeAlimentoAnimal.getText()), Boolean.parseBoolean("false"));
